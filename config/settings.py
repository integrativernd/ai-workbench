...
if PRODUCTION or 'GITHUB_ACTIONS' in os.environ:
    # In production on Heroku or GitHub Actions, the database configuration is derived from the `DATABASE_URL`
    ...
    DATABASES = {
        "default": dj_database_url.config(
            ...
            ssl_require=PRODUCTION,  # Only require SSL in production, not in GitHub Actions
        ),
    }
else:
    DATABASES = {
